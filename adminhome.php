...
<body>
    ...
    <aside>
        <div class="menu">
            <a href="admission.php" class="btn">Admission</a>
            <a href="add_student.php" class="btn">Add Student</a>
            <a href="view_student.php" class="btn">View Student</a>
            <a href="admin_add_teacher.php" class="btn">Add Teacher</a>
            <a href="admin_view_teacher.php" class="btn">View Teacher</a>
        </div>
    ...
    <div class="content">
    <?php if ($current_page === 'adminhome.php') : ?>
