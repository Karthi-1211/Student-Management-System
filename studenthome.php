...
<body>
    ...
    <aside>
        <div class="menu">
            <a href="update1.php" class="btn">Update Details</a>
            <a href="add_material.php" class="btn">Add Materials</a>
            <a href="view_material.php" class="btn">View Materials</a>
        </div>
    ...
    <div class="content">
    <?php if ($current_page === 'studenthome.php') : ?>
